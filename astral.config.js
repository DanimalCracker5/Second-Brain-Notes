/*
  Second Brain — Firebase web configuration
...
window.ASTRAL_CONFIG = {
  firebase: {
    apiKey: "AIzaSyAa3Ru9uKp1F6nkjuyzWQ1pQq4rDBd2sIs",
    authDomain: "second-brain-4077e.firebaseapp.com",
    projectId: "second-brain-4077e",
